...
<a href="?url=tambah-siswa" class="btn btn-primary"> <i class="bi bi-person-add"></i> </a>
<br>
     ...
     ORDER BY nama ASC";
        ...
        foreach ($query as $data) { ?>
            <tr>
                ...
                <td>
                    <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data')" href="?url=hapus-siswa&nisn=<?= $data['nisn'] ?>" class='btn btn-danger'>
